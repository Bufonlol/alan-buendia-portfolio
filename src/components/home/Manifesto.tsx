  ...
  return (
    <section ref={ref} className="manifesto-poster relative overflow-hidden border-b border-paper bg-ink p-3 text-paper md:p-4">
      ...
      <div className="relative z-10 grid grid-cols-6 md:grid-cols-12">
        <div className="manifesto-piece col-span-6 win-window win-window--paper md:col-span-9">
          <WinTitleBar label="VISION.SYS" />
        ...
        <div className="manifesto-piece col-span-4 win-window win-window--paper md:col-span-3">
          <WinTitleBar label="CHAOS.TXT" />
        ...
        <div className="manifesto-piece col-span-6 win-window win-window--paper md:col-span-8 md:row-span-3">
          <WinTitleBar label="MANIFESTO.EXE" />
          <div className="win-body relative flex-1 overflow-hidden px-3 py-7 md:px-6 md:py-8">
        ...
        <div className="manifesto-piece col-span-3 win-window win-window--paper bg-paper text-ink md:col-span-2">
          <WinTitleBar label="RULE001.TXT" />
          <div className="win-body">
        ...
        <div className="manifesto-piece col-span-3 win-window win-window--paper md:col-span-2">
          <WinTitleBar label="RULE002.TXT" />
        ...
        <div className="manifesto-piece manifesto-notice col-span-6 win-window win-window--paper md:col-span-12">
          <WinTitleBar label="NOTICE.TXT" />
          <div className="win-body grid grid-cols-3">
            {[
