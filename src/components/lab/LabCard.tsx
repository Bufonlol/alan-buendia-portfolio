...
export default function LabCard({
  ...
  return (
    <Reveal className="shadow-stack flex flex-col border border-line">
      ...
      <div className="card-notched-sm relative aspect-[4/3] overflow-hidden bg-paper-soft [container-type:inline-size]">
        {children}
      </div>
